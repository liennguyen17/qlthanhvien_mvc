...
<body>
    <div class="timkiem w-50 container mt-5 me-1">
      <form action="" method="GET">
        <table >
          <input type="hidden" name="controller" value="thanhvien">
          <tr class="input-group mb-3 col-md-12 ">
            <td><input  class="form-control col-md-8" type="text" name="tukhoa" placeholder="Nhập từ khóa..."></td>
            <td><input class="btn btn-outline-secondary"  type="submit" value="Tìm kiếm"></td>
          </tr>
        </table>
        <input type="hidden" name="action" value="timkiem">
      </form>
    </div>
    <div class="danhsach mt-3 container ">
